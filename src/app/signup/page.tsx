 ...
 * - 각 입력값에 대해 다음 사항을 확인하세요:
    - [] 이메일 입력창에서 blur될 때, 빈 값이면 “이메일은 필수 입력입니다.” 에러 메시지를 보여주세요.
    - [] 이메일 형식이 아니면 “이메일 형식으로 작성해 주세요.” 에러 메시지를 보여주세요.
    - [] 닉네임이 비어있으면 “닉네임은 필수 입력입니다.” 에러 메시지를 보여주세요.
    - [] 닉네임이 20자를 초과하면 “닉네임은 최대 20자까지 가능합니다.” 에러 메시지를 보여주세요.
    - [] 비밀번호가 비어있으면 “비밀번호는 필수 입력입니다.” 에러 메시지를 보여주세요.
    - [] 비밀번호가 8자 미만이면 “비밀번호는 최소 8자 이상입니다.” 에러 메시지를 보여주세요.
    - [] 비밀번호가 숫자, 영문, 특수문자(!@#$%^&*)만으로 이루어지지 않았다면 “비밀번호는 숫자, 영문, 특수문자로만 가능합니다.” 에러 메시지를 보여주세요.
    - [] 비밀번호 확인 창에서 빈 값이면 “비밀번호 확인을 입력해주세요.” 에러 메시지를 보여주세요.
