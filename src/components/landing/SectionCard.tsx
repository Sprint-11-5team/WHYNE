...
export default function SectionCard() {
  return (
    <div className="flex-between gap-[1rem]">
      <div className="card-container shadow-md shadow-current w-[19.3rem] h-[16rem] pt-[2.4rem] px-[2.5rem] ">
        <Image width={143} src={firstWine} alt="추천 와인 예시" />
      </div>
      <div className="card-container shadow-current shadow-md w-[19.3rem] h-[16rem] pt-[2.4rem] px-[2.5rem]">
