            ...
            <div className='w-[50rem] h-auto rounded-[1.1rem] bg-white pl-[1.8rem] pr-[1.8rem]'>
                <section className='flex-between pt-[1.5rem]'>
                    ...
                    <button
                        type='button'
                        onClick={onClick}
                        className='text-gray-500 tablet:text-2xl mobile:text-2lg'
                    >
                        X
                    </button>
                </section>
                <form className='w-full' onSubmit={handleSubmit}>
                    ...
                    <div className='relative inline-block px-[1.2rem]'>
                        <p className='text-gray-800 font-bold tablet:text-xl mobile:text-lg cursor-pointer border-b-[0.4rem] border-dotted border-transparent hover:border-primary transition-all duration-300'>
                            와인의 맛은 어땠나요?
                        </p>
                    </div>
                    <TasteSlider />
                    <div className='relative inline-block px-[1.2rem]'>
                        <p className='text-gray-800 font-bold tablet:text-xl mobile:text-lg cursor-pointer border-b-[0.4rem] border-dotted border-transparent hover:border-primary transition-all duration-300 mt-[2rem] mb-[1rem]'>
                            기억에 남는 향이 있나요?
                        </p>
                    </div>
                    <TagSelector />
