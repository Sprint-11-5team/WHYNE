...
export default function EntireCard({ data }: EntireCardProp) {
  ...
  return (
    <div className="dark:bg-white tablet:mt-[6.2rem] mobile:mt-[3rem] h-auto desktop:w-[80rem] tablet:w-[70rem] mobile:w-[34.3rem] border-solid border-[0.1rem] border-gray-300 rounded-[1.6rem] shadow-md">
      <Link href={`/wines/${id}`}>
          ...
          <div className="flex justify-between w-auto tablet:flex-row mobile:flex-col tablet:gap-[9.1rem]">
            <div className="tablet:w-[30rem] mobile:w-[18.7rem] flex flex-col tablet:gap-[1.8rem] mobile:gap-[0.8rem]">
              ...
              <div className="flex justify-between desktop:mb-[2.3rem] tablet:mb-[3.7rem]">
                <span className="bg-secondary text-primary font-bold flex justify-center items-center w-auto h-[auto] tablet:py-[0.8rem] tablet:px-[1.5rem] tablet:text-2lg tablet:rounded-[1.2rem] mobile:rounded-[1rem] mobile:py-[0.6rem] mobile: px-[1rem] mobile:text-md">
                  ₩ {price.toLocaleString()}
                </span>
              </div>
            </div>
            <div className="tablet:w-[11.2rem] h-[12.1rem] flex tablet:flex-col tablet:gap-[1rem] mobile:gap-[3.6rem] tablet:mt-0 mobile:mt-[2.2rem] tablet:mb-0 mobile:mb-[2.8rem] tablet:items-start mobile:items-center">
