...
export default function CardList() {
  return (
    <>
      ...
      >
        <div
          /* 선 위에 통 */ className="flex desktop:gap-[8rem] tablet:gap-[4.7rem] mobile:gap-[3.6rem] border-b-[0.1rem] border-gray-300 border-solid desktop:pt-[4rem] desktop:pl-[6rem] tablet:pt-[4rem] tablet:pl-[4rem] mobile:pt-[3rem] mobile:pl-[2rem] desktop:pr-[5rem] tablet:pr-[4rem] mobile:pr-[3rem]"
        >
          <Image width={60} src={sample} alt="와인 목록" /*image*/ />
          <div
            /* image옆에 큰 통 */ className="flex justify-between w-auto tablet:flex-row mobile:flex-col tablet:gap-[9.1rem]"
          >
            <div
              /*가운데통 */ className="tablet:w-[30rem] mobile:w-[18.7rem] flex flex-col tablet:gap-[1.8rem] mobile:gap-[0.8rem]"
            >
              <h2
            ...
            <div
              /*후기 및 버튼 */ className="tablet:w-[11.2rem] tablet:h-[12.1rem] flex tablet:flex-col tablet:gap-[1rem] mobile:gap-[3.6rem] tablet:mt-0 mobile:mt-[2.2rem] tablet:mb-0 mobile:mb-[2.8rem] tablet:items-start mobile:items-center"
            >
        ...
        <div
          /*선 밑에 통*/ className="flex flex-col desktop:w-[68rem] tablet:w-[62.4rem] mobile:w-[30.3rem] tablet:gap-[1rem] mobile:gap-[0.8rem]tablet:py-[2rem] desktop:px-[6rem] tablet:px-[4rem] mobile:py-[0.7rem] mobile:px-[2rem]"
        >
